...
# Пример вызова: $ perl 'ConvertKino839.Demidov.S.Disk.1.pl'
...
# ---
	...
	my $filename_839;  # Имя файла с анимацией (образ гибкого диска Вектор-06Ц).

	my @array_839_hex;  # Массив с анимацией.
...
# ---
	...
	if ( $title_hex_bmp_sw == 1)
		...
		# H1145 - перекодировать 1145 байта в шестнадцатиричные символы.
