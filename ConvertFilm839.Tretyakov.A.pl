...
# Пример вызова: $ perl 'ConvertFilm839.Tretyakov.A.pl'
...
# ---
	...
	$filename_839 = 'Disk Images 839/Tretyakov A.839';
...
# ---
	...
	for ($frame = 0; $frame < 164;) # Обработать 164 кадра.
		...
		open (InFileBin, ">" . 'Frames - Tretyakov A/' . $count_frame_zero . '.bmp') or die "Ошибка...";
