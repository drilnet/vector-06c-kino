...
# Пример вызова: $ perl 'ConvertFilm839.Demidov.S.Disk.1.pl'
...
# ---
	...
	$filename_839 = 'Disk Images 839/Demidov S. Disk 1.839';
...
# ---
	...
	for ($frame = 0; $frame < 164;) # Обработать 164 кадра.
		...
		open (InFileBin, ">" . 'Frames - Demidov S. Disk 1/' . $count_frame_zero . '.bmp') or die "Ошибка...";
